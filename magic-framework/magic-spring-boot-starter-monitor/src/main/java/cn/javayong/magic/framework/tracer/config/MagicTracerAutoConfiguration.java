package cn.javayong.magic.framework.tracer.config;

import cn.javayong.magic.framework.common.enums.WebFilterOrderEnum;
import cn.javayong.magic.framework.tracer.core.aop.BizTraceAspect;
import cn.javayong.magic.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "magic.tracer", value = "enable", matchIfMissing = true)
public class MagicTracerAutoConfiguration {
