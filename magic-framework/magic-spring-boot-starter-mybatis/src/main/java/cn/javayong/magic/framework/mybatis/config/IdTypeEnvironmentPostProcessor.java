package cn.javayong.magic.framework.mybatis.config;
...
public class IdTypeEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void setJobStoreDriverIfPresent(ConfigurableEnvironment environment, DbType dbType) {
        ...
        switch (dbType) {
            case POSTGRE_SQL:
                driverClass = "org.quartz.platform.jdbcjobstore.PostgreSQLDelegate";
                break;
            case ORACLE:
            case ORACLE_12C:
                driverClass = "org.quartz.platform.jdbcjobstore.oracle.OracleDelegate";
                break;
            case SQL_SERVER:
            case SQL_SERVER2005:
                driverClass = "org.quartz.platform.jdbcjobstore.MSSQLDelegate";
                break;
            case DM:
            case KINGBASE_ES:
                driverClass = "org.quartz.platform.jdbcjobstore.StdJDBCDelegate";
                break;
        }
        // 设置 driverClass 变量
        if (StrUtil.isNotEmpty(driverClass)) {
