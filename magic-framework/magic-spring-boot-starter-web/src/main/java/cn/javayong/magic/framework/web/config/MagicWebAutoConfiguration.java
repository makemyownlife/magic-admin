package cn.javayong.magic.framework.web.config;

import cn.javayong.magic.framework.common.enums.WebFilterOrderEnum;
import cn.javayong.magic.framework.web.core.filter.CacheRequestBodyFilter;
import cn.javayong.magic.framework.web.core.filter.DemoFilter;
...
public class MagicWebAutoConfiguration implements WebMvcConfigurer {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "magic.demo", havingValue = "true")
