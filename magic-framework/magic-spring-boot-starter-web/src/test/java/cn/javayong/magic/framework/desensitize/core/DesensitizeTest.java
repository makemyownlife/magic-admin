package cn.javayong.magic.framework.desensitize.core;
...
import cn.javayong.magic.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.javayong.magic.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.javayong.magic.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("courage");
