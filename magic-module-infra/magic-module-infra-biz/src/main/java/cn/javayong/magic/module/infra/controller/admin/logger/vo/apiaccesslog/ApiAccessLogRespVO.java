package cn.javayong.magic.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.javayong.magic.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
