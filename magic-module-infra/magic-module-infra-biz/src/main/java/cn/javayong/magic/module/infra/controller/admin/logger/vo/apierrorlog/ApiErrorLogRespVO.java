package cn.javayong.magic.module.infra.controller.admin.logger.vo.apierrorlog;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(cn.javayong.magic.module.system.enums.DictTypeConstants.USER_TYPE)
