package cn.javayong.magic.module.infra.service.logger;
...
import cn.javayong.magic.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.javayong.magic.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.javayong.magic.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.javayong.magic.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.javayong.magic.framework.common.util.date.LocalDateTimeUtils.*;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("magic-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("magic-test");
