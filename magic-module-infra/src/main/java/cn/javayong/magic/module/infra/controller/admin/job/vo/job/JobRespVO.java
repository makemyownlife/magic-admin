package cn.javayong.magic.module.infra.controller.admin.job.vo.job;
...
import cn.javayong.magic.module.infra.domain.enums.DictTypeConstants;
...
public class JobRespVO {
    ...
    @Schema(description = "处理器的参数", example = "magic")
