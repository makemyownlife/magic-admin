package cn.javayong.magic.module.system.controller.admin.oauth2;
...
import cn.javayong.magic.framework.common.util.http.HttpUtils;
import cn.javayong.magic.framework.common.util.json.JsonUtils;
import cn.javayong.magic.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import cn.javayong.magic.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.javayong.magic.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.javayong.magic.module.system.convert.oauth2.OAuth2OpenConvert;
import cn.javayong.magic.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.javayong.magic.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.javayong.magic.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.javayong.magic.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import cn.javayong.magic.module.system.service.oauth2.OAuth2ApproveService;
import cn.javayong.magic.module.system.service.oauth2.OAuth2ClientService;
import cn.javayong.magic.module.system.service.oauth2.OAuth2GrantService;
import cn.javayong.magic.module.system.service.oauth2.OAuth2TokenService;
import cn.javayong.magic.module.system.util.oauth2.OAuth2Utils;
...
import static cn.javayong.magic.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
...
public class OAuth2OpenController {
    ...
    public CommonResult<String> approveOrDeny(@RequestParam("response_type") String responseType,
        ...
        scopes = ObjectUtil.defaultIfNull(scopes, Collections.<String, Boolean>emptyMap());  // 显式指定泛型
        // 0. 校验用户已经登录。通过 Spring Security 实现
