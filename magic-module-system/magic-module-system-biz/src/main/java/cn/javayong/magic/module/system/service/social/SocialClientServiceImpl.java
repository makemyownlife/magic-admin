package cn.javayong.magic.module.system.service.social;
...
import cn.javayong.magic.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.javayong.magic.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.javayong.magic.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.javayong.magic.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.javayong.magic.module.system.dal.dataobject.social.SocialClientDO;
import cn.javayong.magic.module.system.dal.mysql.social.SocialClientMapper;
...
import static cn.javayong.magic.framework.common.util.collection.MapUtils.findAndThen;
import static cn.javayong.magic.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${magic.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${magic.wxa-subscribe-message.miniprogram-state:formal}")
