package cn.javayong.magic.module.system.service.user;
...
import cn.javayong.magic.module.system.controller.admin.user.vo.user.*;
...
import cn.javayong.magic.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.javayong.magic.module.system.dal.mysql.dept.UserPostMapper;
...
import static cn.javayong.magic.framework.common.util.collection.SetUtils.asSet;
...
import static cn.javayong.magic.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("magicyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("magicyuanma");
        ...
        assertEquals("magicyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("magicyuanma"))).thenReturn("java");
